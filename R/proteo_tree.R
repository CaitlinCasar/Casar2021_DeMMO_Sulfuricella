...
files <- list.files("../data/tree/proteo_tree", full.names = T)
...
taxa_colors <- c("#DAA520", rep("black", 6), "#da3c20", rep("black",2))
...
cairo_pdf("../figures/sulfuricella_tree_proteo_proteins.pdf", 
